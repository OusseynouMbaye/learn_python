...
# methode append:permet d'ajouter juste un element
liste.append(6)  # output : [1, 2, 3, 4, 5, 6]
print(liste)
# methode extend ajoute plusieur elements mais en le passant dans une liste
